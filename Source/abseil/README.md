...
## Submodule
https://github.com/abseil/abseil-cpp/tree/lts_2023_08_02

## Patch
```
cd %TL_LIBRARIES_PATH%/Source/abseil/abseil-20230802
git apply --whitespace=nowarn ../patch/diff-base-on-2023-08-02.patch
```
...
cmake -G "Visual Studio 16 2019" ^
 ...
 %TL_LIBRARIES_PATH%/Source/abseil/abseil-20230802
