...
template <>
::test::Person_PhoneNumber* Arena::CreateMaybeMessage<::test::Person_PhoneNumber>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class Person final :
 ...
 public:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::test::Person_PhoneNumber >*
      mutable_phones();
  private:
  const ::test::Person_PhoneNumber& _internal_phones(int index) const;
  ::test::Person_PhoneNumber* _internal_add_phones();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::test::Person_PhoneNumber>& _internal_phones() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::test::Person_PhoneNumber>* _internal_mutable_phones();
  public:
...
inline const ::test::Person_PhoneNumber& Person::_internal_phones(int index) const {
...
inline ::test::Person_PhoneNumber* Person::_internal_add_phones() {
  return _internal_mutable_phones()->Add();
}
inline ::test::Person_PhoneNumber* Person::add_phones() {
  ::test::Person_PhoneNumber* _add = _internal_add_phones();
